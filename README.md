# rails_movies
his is a super-easy to follow Rails/React API tutorial that is fully in depth from start to finish. This guide shows you how to install a Ruby on Rails 6 API with React JS via Webpacker and connecting the frontend with the backend.
...
**Maosen Hu** ©  Released under the [MIT](./LICENSE) License.<br>
